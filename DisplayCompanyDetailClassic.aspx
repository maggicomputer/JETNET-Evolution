        ...
        <div class="row valueSpec viewValueExport Simplistic aircraftSpec">
                                        ...
                                        <asp:Label ID="regular_toggle_buttons" runat="server">
                                            <asp:UpdatePanel ID="control_update_panel" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    ...
                                                    <div class="dropdownSettings-sub" runat="server" id="cssExportMenu2" visible="false">
                                                        <a href="#">
                                                            <img src="images/download.svg" alt="Download" /></a>
                                                        <div class="dropdown-content-sub">
                                                            <a href="#"><strong>EXPORT/REPORTS</strong></a>
            ...
            <div class="grid">
                <div class="six columns remove_margin main">
                    ...
                    <asp:Panel runat="server" ID="informationContainer" CssClass="Box">
                                    ...
                                    <asp:Label runat="server" ID="AircraftTextHeader" CssClass="subHeader">AIRCRAFT</asp:Label><asp:DataGrid
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn HeaderText="<b class='title'>Type/Contact</b>" ItemStyle-VerticalAlign="Top"
                                                HeaderStyle-VerticalAlign="Top" ItemStyle-CssClass="mobile_display_off_cell" HeaderStyle-CssClass="mobile_display_off_cell">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="type" CssClass='<%#IIF(instr(DataBinder.Eval(Container.DataItem, "act_name"),"Exclusive Broker") > 0,"light_purple_background padding_text", "" & IIF(instr(DataBinder.Eval(Container.DataItem, "act_name"),"Lessee") > 0,"light_orange_background padding_text", "") & "") %>'><%#crmWebClient.DisplayCompanyDetail.showFractionalPercent(DataBinder.Eval(Container.DataItem, "act_name").ToString, DataBinder.Eval(Container.DataItem, "acref_owner_percentage").ToString)%></asp:Label>
                                                    -
                ...
                <asp:LinkButton runat="server" ID="closeFolders" CssClass="float_right padding" OnClick="ViewCompanyFolders"
                    ...
                    <asp:Panel runat="server" ID="BusinessTypeCertificationContainer" Visible="false">
                        <div class="Box">
                    ...
                    <asp:Panel runat="server" ID="RelatedCompanyServicesContainer" Visible="false">
                        <div class="Box">
                            <div class="subHeader">
                    ...
                    <asp:UpdatePanel ID="relationships_udpate_panel" runat="server" ChildrenAsTriggers="True"
                        UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:Panel runat="server" ID="RelationshipsContainer" CssClass="Box" Visible="false">
                        ...
                        <ContentTemplate>
                            <asp:Panel runat="server" ID="dealerPerformancePanel" Visible="false" CssClass="grid-item">
                                ...
                                <div class="Box">
                                    ...
                                    <div class="tab_container_div2 overflow_hidden">
                                        <div id="chart_div_sales_per_year_all">
                                        </div>
                                    </div>
                                </div>
                                <div class="Box">
                                    <!--Models Represented Dealer Performance-->
                        ...
                        <ContentTemplate>
                            <asp:Panel runat="server" ID="aircraftOwnershipPanel" Visible="false" CssClass="grid-item">
                                <div class="Box">
                                    ...
                                    <div class="tab_container_div2 overflow_hidden">
                                        <div id="ownership_sales_per_year_all">
                                        </div>
                                    </div>
                                    <hr />
                        ...
                        <ContentTemplate>
                            <asp:Panel runat="server" ID="AircraftOperationsPanel" Visible="false" CssClass="grid-item">
                                <div class="Box">
                                    ...
                                    <asp:Label runat="server" ID="aircraft_operations_airport_utilization_label"></asp:Label>
                                </div>
                            </asp:Panel>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                        ...
                        <ContentTemplate>
                            <asp:Panel runat="server" ID="AircraftManufacturerPanel" Visible="false" CssClass="grid-item">
                                <div class="Box">
                                    ...
                                    <br />
                                    <div class="tab_container_div2 overflow_hidden">
                                        <div id="manufacturer_production_aircraft_year_all">
                                        </div>
                                    </div>
                                    <hr />
                                    ...
                                    <br />
                                    <div class="tab_container_div2 overflow_hidden">
                                        <div id="manufacturer_operation_aircraft_year_all">
                                        </div>
                                    </div>
                        ...
                        <ContentTemplate>
                            <asp:Panel runat="server" ID="AircraftFinancialPanel" Visible="false" CssClass="grid-item">
                                <div class="Box">
                                    ...
                                    <br />
                                    <div class="tab_container_div2 overflow_hidden">
                                        <div id="aircraft_documents_month_all">
                                        </div>
                                    </div>
                                </div>
                            </asp:Panel>
                            ...
                            <asp:Panel runat="server" ID="AircraftLeasedPanel" Visible="false" CssClass="grid-item">
                                <div class="Box">
                                    ...
                                    <div class="tab_container_div2 overflow_hidden" runat="server" id="leasesPerMonthGraphContainer">
                                        ...
                                        <div id="aircraft_leases_per_month_all">
                                        </div>
                                    </div>
                                </div>
                            </asp:Panel>
                    ...
                    <asp:Panel runat="server" CssClass="grid-item Box" ID="notesMainContainer" Visible="false"></asp:Panel>
                    <!--</div>-->
                </div>
            </div>
        </div>
