...
'
'$$Archive: /commonWebProject/DisplayCompanyDetailTile.aspx.vb $
'$$Author: Amanda $
'$$Date: 3/17/20 4:19p $
'$$Modtime: 3/17/20 4:19p $
'$$Revision: 12 $
'$$Workfile: DisplayCompanyDetailTile.aspx.vb $
'
' ********************************************************************************
...
Partial Public Class DisplayCompanyDetailTile
    ...
    Public Shared txtAlias As String = ""
    ...
    Public Shared TiledView As Boolean = True
    Private Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        Try
            ...
            Else
                ...
                Else
                    ...
                    prospectsContainer.CssClass = "display_none" ' grid-item"
                End If
                '----------------------------------------------------------------------------------------
        ...
        Catch ex As Exception
            HttpContext.Current.Session.Item("localUser").crmUser_DebugText += "<br /> error on DisplayCompanyDetailTile_Init : " + Now.ToString + " [ " + ex.Message.Trim + "]<br />"
        ...
        Try
            ...
            Else
                ...
                If AclsData_Temp.is_aerodex_insight() = True Then
                    ...
                    '  operations_link.Text = "<a href='#' onclick=""javascript:load('DisplayCompanyDetailTile.aspx?compid=" & CompanyID & "&amod_id=" & amod_id & "&use_insight_op=Y','','scrollbars=yes,menubar=no,height=900,width=1050,resizable=yes,toolbar=no,location=no,status=no');return false;"">Aircraft Operations</a>"
                    ' ownership_link.Text = "<a href='#' onclick=""javascript:load('DisplayCompanyDetailTile.aspx?compid=" & CompanyID & "&amod_id=" & amod_id & "&use_insight_op=Y','','scrollbars=yes,menubar=no,height=900,width=1050,resizable=yes,toolbar=no,location=no,status=no');return false;"">Aircraft Ownership</a>"
                    'rollup_link.Text = "<a href='#' onclick=""javascript:load('DisplayCompanyDetailTile.aspx?compid=" & CompanyID & "&amod_id=" & amod_id & "&use_insight_op=Y','','scrollbars=yes,menubar=no,height=900,width=1050,resizable=yes,toolbar=no,location=no,status=no');return false;"">Rollup Locations</a>"

                    If use_insight_op = True Then
                        current_insight = "&use_insight_op=Y"
                        operations_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "" & roll_link & "' class=""subMenuText"">Close Aircraft Operations</a>"
                    Else
                        operations_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "&use_insight_op=Y" & roll_link & "' class=""subMenuText"">Aircraft Operations</a>"
                    End If

                    If use_insight_own = True Then
                        current_insight = "&use_insight_own=Y"
                        ownership_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "" & roll_link & "' class=""subMenuText"">Close Aircraft Ownership</a>"
                    Else
                        ownership_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "&use_insight_own=Y" & roll_link & "' class=""subMenuText"">Aircraft Ownership</a>"
                    End If

                    If use_insight_manu = True Then
                        current_insight = "&use_insight_manu=Y"
                        Me.manu_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "" & roll_link & "' class=""subMenuText"">Close Aircraft Manufactured</a>"
                    Else
                        Me.manu_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "&use_insight_manu=Y" & roll_link & "' class=""subMenuText"">Aircraft Manufactured</a>"
                    End If
                    ...
                    Else
                        If use_insight_dealer = True Then
                            ...
                            Me.dealer_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "" & roll_link & "' class=""subMenuText"">Close Dealer Performance</a>"
                        Else
                            Me.dealer_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "&use_insight_dealer=Y" & roll_link & "' class=""subMenuText"">Dealer Performance</a>"
                        End If
                    End If
                    ...
                    If use_insight_lease = True Then
                        ...
                        Me.lease_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "" & roll_link & "' class=""subMenuText"">Close Aircraft Leasing</a>"
                    Else
                        Me.lease_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "&use_insight_lease=Y" & roll_link & "' class=""subMenuText"">Aircraft Leasing</a>"
                    End If
                    ...
                    Else
                        If use_insight_finance = True Then
                            ...
                            Me.financial_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "" & roll_link & "' class=""subMenuText"">Close Financial Documents</a>"
                        Else
                            Me.financial_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "&use_insight_finance=Y" & roll_link & "' class=""subMenuText"">Financial Documents</a>"
                        End If
                    End If
                    ...
                    If use_insight_roll = True Then
                        rollup_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "&use_insight_roll=N" & current_insight & "'><font color='#25517d'>SHOW MY LOCATION ONLY</font></a>"
                        Me.clear_model.Text = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&aport_id=" & aport_id & "&use_insight_roll=Y" & current_insight & "'><strong><font color='#25517d'>CLEAR AIRCRAFT MODEL</font></strong></a>"
                    Else
                        rollup_link.Text = "" & count_locations & " LOCATIONS - <a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "&use_insight_roll=Y" & current_insight & "'><font color='#25517d'>SHOW ALL</font></a>"
                        Me.clear_model.Text = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&aport_id=" & aport_id & "&use_insight_roll=N" & current_insight & "'><strong><font color='#25517d'>CLEAR AIRCRAFT MODEL</font></strong></a>"
                    End If

                    ' if we are rolled but no insight
                    If use_insight_roll = True And Trim(current_insight) = "" Then
                        operations_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "&use_insight_op=Y&use_insight_roll=Y' class=""subMenuText"">Aircraft Operations</a>"
                        ownership_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "&use_insight_own=Y&use_insight_roll=Y' class=""subMenuText"">Aircraft Ownership</a>"
                        rollup_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&aport_id=" & aport_id & "'><font color='#25517d'>SHOW MY LOCATION ONLY</font></a>"
                        Me.dealer_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "&use_insight_dealer=Y&use_insight_roll=Y' class=""subMenuText"">Dealer Performance</a>"
                        Me.manu_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "&use_insight_manu=Y&use_insight_roll=Y' class=""subMenuText"">Aircraft Manufactured</a>"

                    ElseIf use_insight_roll = False And Trim(current_insight) = "" Then ' just normal company 
                        operations_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "&use_insight_op=Y' class=""subMenuText"">Aircraft Operations</a>"
                        ownership_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "&use_insight_own=Y' class=""subMenuText"" class=""subMenuText"">Aircraft Ownership</a>"
                        rollup_link.Text = "" & count_locations & " LOCATIONS - <a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "&use_insight_roll=Y'><font color='#25517d'>SHOW ALL</font></a>"
                        Me.dealer_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "&use_insight_dealer=Y' class=""subMenuText"">Dealer Performance</a>"
                        Me.manu_link.Text = "<a href='DisplayCompanyDetailTile.aspx?compid=" & CRMJetnetID & "&amod_id=" & amod_id & "&aport_id=" & aport_id & "&use_insight_manu=Y' class=""subMenuText"">Aircraft Manufactured</a>"
                    End If
                    ...
                    If CompanyID <> 0 Then
                        ...
                        Else
                            ...
                            If (Session.Item("jetnetAppVersion") = Constants.ApplicationVariable.CUSTOMER_CENTER) Or (Session.Item("jetnetAppVersion") = Constants.ApplicationVariable.HOMEBASE) Then
                                ...
                                Fill_Related_Company_Services_Tab()
                            ...
                            If Not Page.IsPostBack Then
                                ...
                                'This needs to be removed as soon as the new page becomes the standard page.
                                information_label.Text = Replace(information_label.Text, " class=""Box""", "")
                                ...
                                Else
                                    ...
                                    Else
                                        RelationshipsContainer.Visible = False
                                    End If
                                ...
                                If Session.Item("localSubscription").crmBusiness_Flag = True Then
                                    ...
                                    If Not HttpContext.Current.Session.Item("localPreferences").isYachtOnlyProduct Then
                                        ...
                                        'BusinessTypeCertificationContainer.Visible = False
                ...
                If use_insight_op = True Or use_insight_own = True Or use_insight_roll Or use_insight_dealer = True Or use_insight_manu = True Or use_insight_lease = True Or use_insight_finance = True Then
                    ...
                    If use_insight_roll = True And use_insight_own = False And use_insight_op = False And use_insight_dealer = False And use_insight_manu = False And use_insight_lease = False And use_insight_finance = False Then
                        ...
                        'RelationshipsContainer.Visible = True
                    Else
                        'newsContainer.Visible = True
                        If use_insight_finance = True Then
                            AircraftFinancialPanel.Visible = True
                        ...
                        ElseIf use_insight_own = True Then
                            'This toggles on the main Ownership Block
                            aircraftOwnershipPanel.Visible = True
                            'Sets Page Title.
                            masterPage.SetPageText("Ownership - " & company_name.Text)
                        ElseIf use_insight_op = True Then
                            AircraftOperationsPanel.Visible = True
                            masterPage.SetPageText("Operations - " & company_name.Text)
                        ElseIf use_insight_dealer = True Then
                            'This turns on the dealer performance block.
                            dealerPerformancePanel.Visible = True
                            'This toggles off the aircraft model section for the dealer performance block.
                            If searchCriteria.ViewCriteriaAmodID > 1 Then
                                Me.dealer_performance_model.Visible = False
                            Else
                                Me.dealer_performance_model.Visible = True
                            End If
                            'Sets Page Title
                            masterPage.SetPageText("Dealer Performance - " & company_name.Text)
                        ElseIf use_insight_manu = True Then
                            AircraftManufacturerPanel.Visible = True
                        ...
                        ElseIf use_insight_lease = True Then
                            AircraftLeasedPanel.Visible = True
                            'Me.relationships_label.Text = ""
    ...
    Private Sub Fill_Airport_Model_Tab()
        ...
        If use_insight_own = True Then
            util_functions.get_company_ownership_top_function(searchCriteria, Me.aircraft_ownership_history_label.Text, "", "company", "")
            this_section_string = ""
            If use_insight_roll = True Then
            ...
            DisplayFunctions.load_google_chart(New AjaxControlToolkit.TabPanel, this_section_string, "Company Purchase History", "", "ownership_sales_per_year_all", 0, 0, "POINTS", 1, String_to_return, Me.Page, Me.aircraft_ownership_update_panel, False, False, True, False, False, False, False, True, False, False, 0, "bottom")
            Call load_google_chart_all(New AjaxControlToolkit.TabPanel, String_to_return)
        ElseIf use_insight_op = True Then
            util_functions.get_flight_activity_by_model_top_function(searchCriteria, aircraft_operations_model_utilization_label.Text, "", "company")
            this_section_string = ""

            ''''''''''''''''''''''''''''''''
            'None of this down below really does anything except create a broken graph that really doesn't make any sense to me.. So I commented it out. 3/13/20 - Amanda Vaughn.
            ''''''''''''''''''''''''''''''''
            ...
            'DisplayFunctions.load_google_chart(New AjaxControlToolkit.TabPanel, this_section_string, "Operator # Flts", "", "chart_div_operator_number_flts_all", 465, 285, "POINTS", 1, String_to_return, Me.Page, Me.aircraft_operations_update_panel, False, False, True, False, False, False, False, True, False, False, 0, "bottom")
            'Call load_google_chart_all(New AjaxControlToolkit.TabPanel, String_to_return)

            Call util_functions.util_get_operator_airports_top_function(searchCriteria, aircraft_operations_airport_utilization_label.Text, 0, "", 0, "", "company", False)
        ...
        ElseIf use_insight_dealer = True Then
            ...
            Else
                ...
                Call models_operated(HoldTable, dealer_performance_model.Text, CompanyID, searchCriteria.ViewCriteriaAmodID, searchCriteria)
            ...
            DisplayFunctions.load_google_chart(New AjaxControlToolkit.TabPanel, this_section_string, "Dealer Sales Per Year", "Sales", "chart_div_sales_per_year_all", 0, 0, "ARRAY", 1, String_to_return, Me.Page, Me.dealer_performance_update_panel, False, True, True, False, False, False, False, False, False, False, 0, "bottom")
        ...
        ElseIf use_insight_manu = True Then
            ...
            this_section_string = ""
            Call use_manu_functions(Me.aircraft_manufacturer_summary_label.Text, Me.aircraft_models_manufactured_label.Text)


        ElseIf use_insight_lease = True Then

            Call use_insight_lease_functions(aircraft_lessor_summary.Text, Me.aircraft_leased_models_leased_label.Text)
    ...
    Public Sub BuildRestOfDealerCharts(ByVal companyID As Long, ByRef searchCriteria As viewSelectionCriteriaClass, ByRef returnString As String, ByVal company_string As String, Optional ByVal ac_dealer_view As Boolean = False)
        If companyID > 0 Then
            ...
            sales_roles_since_header.InnerText = "DEALER SALES ROLES SINCE " & Year(Now()) - 1
            DisplayFunctions.load_google_chart(New AjaxControlToolkit.TabPanel, MapString, "", "", "sales_roles_since_chart_div_all", 0, 0, "ARRAY", 2, returnString, Me.Page, Me.dealer_performance_update_panel, False, False, False, False, False, False, False, False, False, True)
            ...
            If Not IsNothing(TempTable) Then
                ...
                ResultsString += "<div Class=""subHeader"">DEALER SALES SINCE " & Year(DateAdd(DateInterval.Year, -1, Now())) & ""
                ...
                If TempTable.Rows.Count > 0 Then
                    ...
                    ResultsString += "</table>"
                    dealer_sales_since_label.Text = ResultsString
                End If
            End If
    ...
    Public Sub use_insight_lease_functions(ByRef company_text As String, ByRef model_text As String)
        ...
        If Not IsNothing(HoldTable) Then
            If HoldTable.Rows.Count > 0 Then
                ...
                Next
            Else
                leasesPerMonthGraphContainer.Visible = False ' there is no data to graph 
            End If
        Else
            leasesPerMonthGraphContainer.Visible = False ' there is no data to graph 
        End If
        ...
        DisplayFunctions.load_google_chart(New AjaxControlToolkit.TabPanel, this_section_string, "Leases Per Month", "", "aircraft_leases_per_month_all", 0, 0, "ARRAY", 1, String_to_return, Me.Page, Me.aircraft_leased_update_panel, False, True, True, False, False, False, False, False, False, False, 0, "bottom")
        Call load_google_chart_all(New AjaxControlToolkit.TabPanel, String_to_return)
    ...
    Private Sub BuildLeaseSummaryTab(ByRef searchCriteria As viewSelectionCriteriaClass)
        ...
        If Not IsNothing(LeaseTable) Then
            If LeaseTable.Rows.Count > 0 Then
                ...
                aircraft_leased_summary_label.Text = DisplayText
            End If
        End If
    End Sub
    ...
    Public Sub use_manu_functions(ByRef company_text As String, ByRef model_text As String)
        ...
        If searchCriteria.ViewCriteriaCompanyID > 0 Then
            ...
            If searchCriteria.ViewCriteriaAmodID = -1 Then
                ...
                company_text = Replace(sHtmlManufacturerCompanies, "data_aircraft_grid", "formatTable blue small")
                ...
                model_text = Replace(sHtmlManufacturerModels, "data_aircraft_grid", "formatTable blue small")
            ...
            DisplayFunctions.load_google_chart(New AjaxControlToolkit.TabPanel, this_section_string, "In Operation Aircraft By MFR Year", "", "manufacturer_operation_aircraft_year_all", 0, 0, "ARRAY", 1, String_to_return, Me.Page, aircraft_manufacturing_update_panel, False, True, True, False, False, False, False, False, False, False, 0, "bottom")
            ...
            DisplayFunctions.load_google_chart(New AjaxControlToolkit.TabPanel, this_section_string, "In Production Aircraft By MFR Year", "", "manufacturer_production_aircraft_year_all", 0, 0, "ARRAY", 2, String_to_return, Me.Page, aircraft_manufacturing_update_panel, False, True, True, False, False, False, False, False, False, False, 0, "bottom")
            ...
            If holdtable.Rows.Count > 0 Then
                ...
                For Each r As DataRow In holdtable.Rows
                    ...
                    Else
                        ...
                        htmlOut_Make.Append("<a href='DisplayCompanyDetailTile.aspx?compid=" & CompanyID & "&amod_id=" & r("amod_id") & "&use_insight_dealer=Y&use_insight_roll=" & Trim(Request("use_insight_roll")) & "'>")
        ...
        Else
            ...
            If Not IsNothing(YachtTable) Then
                ...
                Else
                    ...
                    yacht_label.ForeColor = System.Drawing.ColorTranslator.FromHtml("#0c0c0c")
    ...
    Public Sub Fill_Business_Type_Tab()
        ...
        If Not IsNothing(BusinessType) Then
            ...
            End If
            BusinessTypeCertificationContainer.Visible = True
        Else
            If masterPage.aclsData_Temp.class_error <> "" Then
                masterPage.LogError("DisplayCompanyDetailTile.aspx.vb - Fill_Business_Type_Tab() - " & masterPage.aclsData_Temp.class_error)
            End If
        End If
    ...
    Public Sub Fill_Certifications_Tab(ByVal cert_category As String)
        ...
        If Not IsNothing(CertifactionsTable) Then
            If (CertifactionsTable.Rows.Count > 0) Then
                ...
                certifications_label.Text += "<hr />"

                    If Trim(cert_category) = "Certificate" Then
                    certifications_label.Text += "<div class=""subHeader"">Operating Certification(s): "
                ElseIf Trim(cert_category) = "Membership" Then
                    certifications_label.Text += "<div class=""subHeader"">Membership(s): "
                ElseIf Trim(cert_category) = "Accreditation" Then
                    certifications_label.Text += "<div class=""subHeader"">Accreditation(s): "
                Else
                    certifications_label.Text += "<div class=""subHeader"">Operating Certification(s): "
                End If
                ...
                certifications_label.Text += "<div class=""clearfix""></div>"
            End If
    ...
    Public Sub Fill_Admin_Action_Items()
        ...
        Else
            If masterPage.aclsData_Temp.class_error <> "" Then
                masterPage.LogError("DisplayCompanyDetailTiles.aspx.vb -FillAdminActionItems() - " & masterPage.aclsData_Temp.class_error)
            End If
        End If
    End Sub
            ...
            If (service_table.Rows.Count > 0) Then
                ...
                For Each q As DataRow In service_table.Rows
                    If OldService <> q("SERVICE") Then
                        ...
                        If Not IsDBNull(q("SERVICE")) Then
                            OldService = q("SERVICE")
                        End If
                    End If
                Next
            Else
    ...
    Public Sub Fill_Service_Summary_Tab(ByRef ShowSubscriptionSummary As Boolean)
        ...
        If Not IsNothing(service_table) Then
            ...
            Me.services_label.Text = htmlOut.ToString & "<hr />"
        Else
            If masterPage.aclsData_Temp.class_error <> "" Then
                masterPage.LogError("CompanyTabs.ascx.vb -Fill_Service_Summary_Tab() - " & masterPage.aclsData_Temp.class_error)
            End If
    ...
    Public Sub Fill_Related_Company_Services_Tab()
        Dim service_table As New DataTable
        Dim htmlOut As New StringBuilder
        subscription_label.Visible = True
        Dim temp_desc As String = ""
        ...
        service_table = Return_Related_Company_Services(CompanyID, JournalID)


        If Not IsNothing(service_table) Then
            'SERVICE, COMPANY, And #LIC 
            htmlOut.Append("<table id='subscriptionTable' width=""100%"" cellpadding=""0"" cellspacing=""0"" border=""0"" class=""formatTable blue small aircraftTable"">")
            htmlOut.Append("<tr class='header_row'>")
            htmlOut.Append("<td align='left'><b>SERVICE</b></td>")
            htmlOut.Append("<td align='left'><b>COMPANY</b></td>")
            ...
            If (service_table.Rows.Count > 0) Then
                ...
                For Each q As DataRow In service_table.Rows
                    ...
                    htmlOut.Append("<td align='left'>" + q("serviceName").ToString.Trim + "</td>")
                    If Not IsDBNull(q("comp_id")) And Not IsDBNull(q("comp_name")) Then
                        htmlOut.Append("<td align='left'>" & DisplayFunctions.WriteDetailsLink(0, q("comp_id"), 0, 0, True, q("comp_name").ToString, "emphasisColor", "") & " ")
                    Else
                        htmlOut.Append("<td align='left'>")
                    End If

                    If Not IsDBNull(q("comp_city")) Then
                        htmlOut.Append(q("comp_city"))
                    End If
                    If Not IsDBNull(q("comp_state")) Then
                        If Not IsDBNull(q("comp_city")) Then
                            htmlOut.Append(", ")
                        End If
                        htmlOut.Append(q("comp_state"))
                    End If
                    If Not IsDBNull(q("compCountry")) Then
                        htmlOut.Append(" " & q("compCountry"))
                    End If
                    htmlOut.Append("</td>")
                    htmlOut.Append("<td align='right'>")
                ...
                Next
            Else
                RelatedCompanyServicesContainer.Visible = False
                related_company_services_label.Visible = False
            End If

            htmlOut.Append("</table>")

            Me.related_company_services_label.Text = htmlOut.ToString
        Else
            If masterPage.aclsData_Temp.class_error <> "" Then
                masterPage.LogError("CompanyTabs.ascx.vb -Fill_Related_Company_Services_Tab() - " & masterPage.aclsData_Temp.class_error)
            End If
        End If
    End Sub
    Public Function Return_Related_Company_Services(ByVal compID As Long, ByVal JournalID As Long) As DataTable
        Dim sql As String = ""
        ...
        Try
            ...
            sql += "select distinct replace(sub_service_name,'Evolution ','') as serviceName, comp_id, comp_name, comp_city, comp_state, replace(comp_country,'United States','USA') as compCountry, COUNT(distinct contact_email_address) as LICENSES"
            sql += " from ReturnAllCompanyLocationsByCompId(" & compID.ToString & ") "
            sql += " inner join " + IIf(HttpContext.Current.Session.Item("jetnetAppVersion") = Constants.ApplicationVariable.CUSTOMER_CENTER, "[Homebase].jetnet_ra.dbo.", "") + "View_JETNET_Customers with (NOLOCK) on comp_id = RelCompID And comp_journ_id = 0"
            sql += " where RelCompID <> " & compID.ToString
            sql += " group by replace(sub_service_name,'Evolution ',''), comp_id, comp_name, comp_city, comp_state, replace(comp_country,'United States','USA')"
    ...
    Public Sub Fill_Relationship_Tab()
        ...
        If Not IsNothing(RelationshipTable) Then
            If RelationshipTable.Rows.Count > 0 Then
                ...
                RelationshipsContainer.Visible = True
                relationships_label.Text = "<div class=""subHeader"">COMPANY RELATIONSHIPS</div><br />"
                relationships_label.Text += "<table class=""formatTable blue small companyTable"" width=""100%"">"
                relationships_label.Text += "<tr class=""header_row""><td><b class='title'>Relationship</b></td>"
                relationships_label.Text += "<td><b class='title'>Company</b></td>"
                relationships_label.Text += "<td class=""mobile_display_off_cell""><b class='title'>Contact</b></td>"
                        ...
                        If Not IsNothing(tempContact) Then
                            If tempContact.Rows.Count > 0 Then
                                ...
                                For Each Con As clsClient_Contact In Contact_Class_Array
                                    contact_display = clsGeneral.clsGeneral.Show_Contact_Display(Con, True)
                                Next
                            End If
                        Else
                            If masterPage.aclsData_Temp.class_error <> "" Then
                                masterPage.LogError("DisplayCompanyDetailTile - GetContacts_Details(" & contact_one & ", JETNET"") - " & masterPage.aclsData_Temp.class_error)
                            End If
                        End If
                    End If
                    ...
                    If Not IsNothing(tempData) Then
                        If tempData.Rows.Count > 0 Then
                            ...
                            If Not IsDBNull(r("Relationship")) Then
                                ...
                                relationships_label.Text += "<td valign=""top""><b class=""company_title"">" & DisplayFunctions.WriteDetailsLink(0, company_one, 0, 0, True, tempComp.clicomp_name, "emphasisColor", "") & "</b><br />" & clsGeneral.clsGeneral.Show_Company_Display(tempComp, False) & "" & IIf(contact_display <> "", "<span class=""mobile_display_on_cell""><br />" & contact_display & "</span>", "") & "</td>"
                                relationships_label.Text += "<td valign=""top"" class=""mobile_display_off_cell"">" & contact_display & "</td>"
                            End If
                        End If
                    End If
        ...
        If Session.Item("jetnetAppVersion") = Constants.ApplicationVariable.YACHT And (Session.Item("localSubscription").crmHelicopter_Flag = False Or Session.Item("localSubscription").crmBusiness_Flag = False Or Session.Item("localSubscription").crmCommercial_Flag = False) Then
            If Not IsNothing(AircraftTable) Then
                If AircraftTable.Rows.Count > 0 Then
                    ...
                    Else
                        If Trim(Request("compid")) <> "" Then
                            AircraftTextHeader.Text = "Aircraft (" & company_amount_of_ac.Text & ") <em class='tiny_text'>(1-" & aircraftDataGrid.PageSize & " of " & AircraftTable.Rows.Count & " relationship" & IIf(AircraftTable.Rows.Count = 1, "", "s") & ") <a href='DisplayCompanyDetailTile.aspx?compid=" & Trim(Request("compid")) & "&full_ac=Y'  class=""smallSubLink"">(View All)</a></em>"
                ...
                Else
                    ...
                    aircraft_label.ForeColor = System.Drawing.ColorTranslator.FromHtml("#0c0c0c")
                ...
                If AircraftTable.Rows.Count > 0 Then
                    ...
                    Else
                        If Trim(Request("compid")) <> "" And Trim(Request("full_ac")) = "" Then
                            AircraftTextHeader.Text = temp_title & "Aircraft (" & company_amount_of_ac.Text & ") <em class='tiny_text'>(1-" & aircraftDataGrid.PageSize & " of " & AircraftTable.Rows.Count & " relationship" & IIf(AircraftTable.Rows.Count = 1, "", "s") & ") <a href='DisplayCompanyDetailTile.aspx?compid=" & Trim(Request("compid")) & "&full_ac=Y'  class=""smallSubLink"">(View All)</a></em>"
                        ElseIf Trim(Request("full_ac")) <> "" Then
                            AircraftTextHeader.Text = temp_title & "Aircraft (" & company_amount_of_ac.Text & ") <em class='tiny_text'>(" & AircraftTable.Rows.Count & " relationship" & IIf(AircraftTable.Rows.Count = 1, "", "s") & ")</em>"
                        Else
    ...
    Function GetPostBackFunction() As String
    ...
    Public Sub Get_Company_History()
        ...
        If GetPostBackFunction() = closeHistory.UniqueID Then
    ...
    Public Sub ViewCompanyMap(ByVal sender As Object, ByVal e As System.EventArgs) 'Handles map_this_company.Click
        If GetPostBackFunction() = closeMap.UniqueID Then
            ToggleButtons(False, False, False, False, False, False)
        Else
    ...
    Public Sub ViewCompanyEvents(ByVal sender As Object, ByVal e As System.EventArgs) ' Handles view_company_events.Click
        ...
        If GetPostBackFunction() = closeEvents.UniqueID Then
            ToggleButtons(False, False, False, False, False, False)
        Else
            ...
            If Not IsNothing(eventsTable) Then
                ...
                Else
                    ...
                    events_label.ForeColor = System.Drawing.ColorTranslator.FromHtml("#0c0c0c")
    ...
    Private Sub aircraftDataGrid_PageIndexChanged(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles aircraftDataGrid.PageIndexChanged
        ...
        If Trim(Request("compid")) <> "" Then
            AircraftTextHeader.Text = " Aircraft (" & company_amount_of_ac.Text & ") <em class='tiny_text'>(" & CountString & " of " & HoldTable.Rows.Count & " relationships) <a href='DisplayCompanyDetailTile.aspx?compid=" & Trim(Request("compid")) & "&full_ac=Y' class=""smallSubLink"">(View All)</a></em>"
        Else
    ...
    Public Sub viewCompanyShare(ByVal sender As Object, ByVal e As System.EventArgs) 'Handles view_share_relationships.Click
        Dim ShareTable As New DataTable
        If GetPostBackFunction() = closeShare.UniqueID Then
            ToggleButtons(False, False, False, False, False, False)
        Else
    ...
    Public Sub ViewCompanyFolders(ByVal sender As Object, ByVal e As System.EventArgs) 'Handles view_folders.Click
        If GetPostBackFunction() = closeFolders.UniqueID Then
            ToggleButtons(False, False, False, False, False, False)
        Else
    ...
    Public Sub ViewCompanyNotes(ByVal sender As Object, ByVal e As System.EventArgs) ' Handles view_notes.Click
        If GetPostBackFunction() = closeNotes.UniqueID Then
            ToggleButtons(False, False, False, False, False, False)
        Else
    ...
    Private Sub Fill_Related_Transactions()
        ...
        If Not IsNothing(YachtTable) Then
            ...
            Else
                ...
                yacht_trans_label.ForeColor = System.Drawing.ColorTranslator.FromHtml("#0c0c0c")
    ...
    Public Shared Function showFractionalPercent(ByVal act_name As String, ByVal acref_owner_percentage As String) As String
...
#Region "New_Financial_Docs_Section"
    ...
    Public Sub Build_Financial_Documents_By_Month()
        ...
        If Not IsNothing(DocTable) Then
            If DocTable.Rows.Count > 0 Then
                ...
                DisplayString = "function DrawChartFinancial() {var data = google.visualization.arrayToDataTable(["
                ...
                DisplayString += "},"
                DisplayString += "chartArea: {'left':45,'top':20, 'width':'100%', 'height':'100%'},"
                DisplayString += "'width':0,"
                DisplayString += "'height':0,"
                DisplayString += "bars:   'vertical',"
                DisplayString += "legend: { position: ""none"" }"
                DisplayString += "};"
                DisplayString += "var material = new google.visualization.ColumnChart(document.getElementById('aircraft_documents_month_all'));"
                DisplayString += "material.draw(data, options);}; DrawChartFinancial();"
    ...
    Public Sub Build_Types_Financial_Documents()
        ...
        End If
        DocTable.Dispose()
        aircraft_financial_documents_label.Text = DisplayString
    End Sub
    Public Sub Build_Model_Financial_Documents()
        ...
        End If
        ModTable.Dispose()
        aircraft_models_financed_label.Text = DisplayString
    End Sub

    Private Sub DisplayCompanyDetailTile_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
        ...
        Catch ex As Exception
            If Not IsNothing(masterPage) Then
                masterPage.LogError(System.Reflection.MethodInfo.GetCurrentMethod().ToString & " (DisplayCompanyDetailTile_PreInit): " & ex.Message.ToString)
            Else
                HttpContext.Current.Session.Item("localUser").crmUser_DebugText += " (DisplayCompanyDetailTile_PreInit): " + ex.Message.ToString.Trim
            End If
        End Try
...
#End Region
    ...
    Private Sub DisplayCompanyDetailTile_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete

        If TiledView = True Then
            toggleLink.Text = "<a href=""" & Replace(Request.Url.ToString().ToString, "TILE", "Classic", 1, -1, CompareMethod.Text) & """>Classic View</a>"
        Else
            toggleLink.Text = "<a href=""" & Replace(Request.Url.ToString().ToString, "CLASSIC", "Tile", 1, -1, CompareMethod.Text) & """>Tiled View</a>"
        End If
        ...
        ChartJavaScript += "if (typeof DrawChartFinancial === ""function"") {" & vbNewLine

        ChartJavaScript += "  DrawChartFinancial();" & vbNewLine
        ChartJavaScript += " } " & vbNewLine
        ChartJavaScript += "});" & vbNewLine
        ...
        System.Web.UI.ScriptManager.RegisterStartupScript(Me, Me.GetType(), "ResizePage", ChartJavaScript, True)
    End Sub

    Private Sub customerActivitiesFilter_SelectedIndexChanged(sender As Object, e As EventArgs) Handles customerActivitiesFilter.SelectedIndexChanged, researchNoteDropdown.SelectedIndexChanged
        If Not Page.ClientScript.IsClientScriptBlockRegistered("masonryPost") Then
            System.Web.UI.ScriptManager.RegisterClientScriptBlock(Me, Me.GetType(), "masonryPost", "loadMasonry();", True)
        End If
    End Sub
End Class