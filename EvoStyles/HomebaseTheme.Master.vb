...
'
'$$Archive: /commonWebProject/EvoStyles/HomebaseTheme.Master.vb $
'$$Author: Mike $
'$$Date: 6/14/20 1:49p $
'$$Modtime: 6/14/20 12:42p $
'$$Revision: 10 $
'$$Workfile: HomebaseTheme.Master.vb $
'
' ********************************************************************************

Partial Public Class HomebaseTheme
  ...
  End Sub
    ...
    Else
      ...
      Trace.Write("Start Page_load HomebaseTheme.Master.vb" + Now.ToString)
      ...
      If Not Page.IsPostBack Then
        ...
        If strPageAt = "/homebasehome.aspx" Then
          BuildMenu("Main") 'Build temporary left hand menu on page
        Else
          Dim MenuURLCheck As New DataTable
          MenuURLCheck = localDatalayer.MenuFilter("", "", strPageAt, "HOMEBASE")
    ...
    Trace.Write("End Page_load HomebaseTheme.Master.vb" + Now.ToString)
  ...
  Public Sub BuildMenu(pageName As String)
    ...
    parentTable = localDatalayer.MenuFilter(pageName, "", "", "HOMEBASE")
    ...
    If Not IsNothing(parentTable) Then
      If parentTable.Rows.Count > 0 Then
        ...
        If pageName <> "Main" Then
          ...
          returnString += "<li><a href =""/homebaseHome.aspx"">Dashboard</a></li>"
          ...
          If Not IsDBNull(r("menutree_display_name")) Then
            If Not IsDBNull(r("menutree_display_url")) Then
              ...
              If Not String.IsNullOrEmpty(r("menutree_display_url")) Then
                ...
                returnString += "<li class=""" + activeCSS + """>"
  ...
  Public Function CreateChildren(ByRef returnString As String, ByVal parentName As String, ByRef ChildCount As Integer) As String
    ...
    returnString += "<ul>"
    ReturnTable = localDatalayer.MenuFilter(parentName, "", "", "HOMEBASE")
    If Not IsNothing(ReturnTable) Then
      For Each r As DataRow In ReturnTable.Rows
        ...
        If Not IsDBNull(r("menutree_display_url")) Then
          ...
          returnString += "<li>"
          returnString += "<a href=""" + r("menutree_display_url") + """>"
          returnString += r("menutree_display_name").ToString.Replace(" ", "&nbsp;")
          returnString += "</a>"
        Else
          returnString += "<li>"
