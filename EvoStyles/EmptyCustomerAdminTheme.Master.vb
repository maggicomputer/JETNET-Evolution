Partial Public Class EmptyCustomerAdminTheme
  ...
  Private Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    'If HttpContext.Current.Session.Item("jetnetWebSiteType") = eWebSiteTypes.LOCAL Or HttpContext.Current.Session.Item("jetnetWebSiteType") = eWebSiteTypes.TEST Or HttpContext.Current.Session.Item("jetnetWebSiteType") = eWebSiteTypes.LIVE Then
  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Trace.Write("Start Page_load EmptyCustomerAdminTheme.Master.vb" + Now.ToString)
    ...
    Trace.Write("End Page_load EmptyCustomerAdminTheme.Master.vb" + Now.ToString)
