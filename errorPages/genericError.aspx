<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="genericError.aspx.vb"
    Inherits="crmWebClient.genericError" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Welcome to Jetnet CRM - Web</title>
...
<body>
    ...
    <br />
    <br />
    <table runat="server" cellspacing="0" cellpadding="0" class="login_white_page body_width"
        align="center">
        <tr>
                ...
                <table border="0" cellpadding="4" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td align="center" valign="top">
                            <asp:Label ID="crm_error_message" runat="server" Visible="false">
                            <h1 class="login_h1">
                                JETNET CRM WEB APPLICATION HAS EXPERIENCED AN ERROR</h1>
                            ...
                            <asp:Label ID="evo_error_message" runat="server" Visible="false">
                                <h1 class="login_h1">
                                    <asp:Label runat="server" ID="evo_title">JETNET EVOLUTION</asp:Label>
                                    HAS EXPERIENCED AN ERROR</h1>
                                <p style="text-align: center;">
                                    JETNET Online is a subscription service for authorized users only.
                                    <br />
                                    Unauthorized use of this service may result in both financial and legal actions.<br />
                                    <br />
                                    If you have questions regarding your subscription status or<br>
                                    would like to inquire about subscribing contact <a href="mailto:customerservice@jetnet.com"
                                        title="Send Email to customerservice@jetnet.com"><em>customerservice@jetnet.com</em></a></p>
                            </asp:Label>
                            <br />
