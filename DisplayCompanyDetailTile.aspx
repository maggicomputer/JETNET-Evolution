<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DisplayCompanyDetailTile.aspx.vb"
    Inherits="crmWebClient.DisplayCompanyDetailTile" MasterPageFile="~/EvoStyles/EmptyEvoTheme.Master" %>
...
box-shadow: 1px 1px 2px 1px #C9C9C9;
            ...
            .grid-item .Box .Box, .grid-item.Box .Box{-webkit-box-shadow: 0px 0px 0px 0px #C9C9C9;
    ...
    <div runat="server" id="toggle_vis" class="companyContainer">
        <div class="row valueSpec viewValueExport Simplistic aircraftSpec">
                                                        ...
                                                        <asp:UpdatePanel ID="control_update_panel" runat="server" ChildrenAsTriggers="true">
                                                            <ContentTemplate>
                                                                ...
                                                                <ul class="cssMenu_subpage">
                                                                    <li><a href="#" class="gray_button"><strong>View</strong></a>
                                                                        <ul>
                                                                            <li>
                                                                                <asp:Literal runat="server" ID="toggleLink"></asp:Literal></li>
                                                                            <li>
                                                                                <asp:LinkButton ID="map_this_company" runat="server"
                                                                                    OnClick="ViewCompanyMap"><strong>Map</strong></asp:LinkButton></li>
                                                                        </ul>
                                                                    </li>
            ...
            <div class="grid">
                ...
                <asp:Label ID="history_information_label" runat="server" CssClass="grid-item"></asp:Label>
                <!--Block 1 Main Information-->
                <asp:Panel runat="server" ID="informationContainer" CssClass="grid-item Box">
                ...
                <asp:Panel runat="server" ID="servicesContainer" Visible="false" CssClass="Box grid-item">
                    <div class="subHeader">
                        Service Summary
                    </div>
                ...
                <asp:Label ID="marketing_label" runat="server" Text="" CssClass="grid-item"></asp:Label>
                <!--Block 4 History-->
                <asp:UpdatePanel ID="history_update_panel" runat="server" ChildrenAsTriggers="false"
                    UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Panel runat="server" ID="historyContainer" CssClass="Box grid-item" Visible="false">
                            <div class="subHeader">
                                History
                ...
                <asp:UpdatePanel ID="events_update_panel" runat="server" ChildrenAsTriggers="false"
                    UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Panel runat="server" ID="eventContainer" CssClass="Box grid-item" Visible="false">
                            <div class="subHeader">
                                Events
                ...
                <asp:UpdatePanel ID="folders_update_panel" runat="server" ChildrenAsTriggers="false"
                    UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Panel runat="server" ID="foldersContainer" CssClass="Box grid-item">
                            <div class="subHeader">
                                Folders
                ...
                <asp:UpdatePanel
                    ...
                    <ContentTemplate>
                        <asp:Panel runat="server" CssClass="grid-item Box">
                ...
                <asp:UpdatePanel ID="customerActivitiesUpdate" runat="server" ChildrenAsTriggers="true"
                    ...
                    <ContentTemplate>
                        ...
                        <asp:Panel runat="server" ID="customer_activities_panel" Visible="false" CssClass="Box grid-item">
                            <div class="subHeader">
                                Customer Activities
                            </div>
                ...
                <asp:Panel runat="server" ID="BusinessTypeCertificationContainer" CssClass="grid-item Box">
                ...
                <asp:UpdatePanel ID="relationships_udpate_panel" runat="server" ChildrenAsTriggers="True"
                    UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Panel runat="server" ID="RelationshipsContainer" CssClass="grid-item Box" Visible="false">
                ...
                <asp:UpdatePanel ID="researchPanelUpdate" runat="server" ChildrenAsTriggers="true"
                    UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Panel runat="server" ID="researchNotesPanel" Visible="false" CssClass="Box grid-item">
                            <div class="subHeader">
                                Research Notes
                            </div>
                            <br />
                ...
                <asp:Panel runat="server" ID="dataProviderContainer" CssClass="Box grid-item" Visible="false">
                    <div class="subHeader">
                ...
                <asp:UpdatePanel ID="share_update_panel" runat="server" ChildrenAsTriggers="false"
                    UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Panel runat="server" ID="shareContainer" Visible="false" CssClass="Box grid-item">
