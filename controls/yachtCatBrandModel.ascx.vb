...
'
'$$Archive: /commonWebProject/controls/yachtCatBrandModel.ascx.vb $
'$$Author: Mike $
'$$Date: 6/19/19 8:47a $
'$$Modtime: 6/18/19 6:12p $
'$$Revision: 2 $
'$$Workfile: yachtCatBrandModel.ascx.vb $
'
' ********************************************************************************
...
Partial Public Class yachtCatBrandModel
  ...
  Public controlYachtCategory As String = ""
  Public controlYachtBrand As String = ""
  Public controlYachtModel As String = ""

  Public controlYachtCategoryName As String = ""
  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Try
      ...
      If Trim(Request("ViewID")) = "21" Then
      Else

        ' if our controls are not filled in then use these default values
        If Not IsPostBack Then
          If String.IsNullOrEmpty(controlYachtCategoryName) And String.IsNullOrEmpty(controlYachtBrandName) And String.IsNullOrEmpty(controlYachtModelName) Then
        ...
        If bIsView Then
          controlYachtCategory = Session.Item("viewYachtCategory").ToString
        ...
        Else
          controlYachtCategory = Session.Item("tabYachtCategory").ToString
  ...
  Public Sub setControlName(ByVal sControlBaseName As String)
    controlYachtCategoryName = "cbo" + sControlBaseName + "Category"
