...
'
'$$Archive: /commonWebProject/yachtPicture.aspx.vb $
'$$Author: Mike $
'$$Date: 5/04/20 2:33p $
'$$Modtime: 5/04/20 2:29p $
'$$Revision: 3 $
'$$Workfile: yachtPicture.aspx.vb $
'
' ********************************************************************************
...
Partial Public Class yachtPicture
  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Else
      ...
      YACHT_ID = Request.Item("yt_id")
      JOURNALID = Request.Item("journalID")
      ...
      PictureTable = aclsData_Temp.GetJETNET_Yacht_pictures(YACHT_ID, JOURNALID)
      ...
      If Not IsNothing(PictureTable) Then
        If PictureTable.Rows.Count > 0 Then
          For Each r As DataRow In PictureTable.Rows
            ...
            fAcpic_image_type = "jpg"
            If Not (IsDBNull(r("ytpic_id"))) Then
              If Not String.IsNullOrEmpty(r("ytpic_id").ToString) Then
                fAcpic_id = r("ytpic_id").ToString.Trim
              End If
            End If

            If Not (IsDBNull(r("ytpic_subject"))) Then
              If Not String.IsNullOrEmpty(r("ytpic_subject").ToString) Then
                fAcpic_subject = r("ytpic_subject").ToString.Trim
              End If
            End If
            ...
            picture.Text += ("<a class=""thumb"" name=""leaf"" href=""" + imgFolder + "/" + YACHT_ID.ToString + Constants.cHyphen + JOURNALID.ToString + Constants.cHyphen + fAcpic_id + Constants.cDot + fAcpic_image_type + """ title=""" + fAcpic_subject + """>") & vbNewLine
            picture.Text += ("<img src=""" + imgFolder + "/" + YACHT_ID.ToString + Constants.cHyphen + JOURNALID.ToString + Constants.cHyphen + fAcpic_id + Constants.cDot + fAcpic_image_type + """ alt=""" + fAcpic_subject + " width='550px' "" />") & vbNewLine
            picture.Text += ("</a>") & vbNewLine
            picture.Text += ("<div class=""caption"">") & vbNewLine
            picture.Text += ("<div class=""download"">")
            picture.Text += ("<a href=""" + imgFolder + "/" + YACHT_ID.ToString + Constants.cHyphen + JOURNALID.ToString + Constants.cHyphen + fAcpic_id + Constants.cDot + fAcpic_image_type + """ target='new'>View Original</a>") & vbNewLine
            picture.Text += ("</div>") & vbNewLine
            ...
            picture_plain.Text += ("<img border='0' src='" + imgFolder + "/" + YACHT_ID.ToString + Constants.cHyphen + JOURNALID.ToString + Constants.cHyphen + fAcpic_id + Constants.cDot + fAcpic_image_type + "' Title='" + fAcpic_subject + "' alt='" + fAcpic_subject + "'  width='650' style='padding-bottom:3px;' /><h3 class='caption_text_large'>" & fAcpic_subject & "</h3><br /><br />")
      ...
      javascript_text.Text += ("$('#thumbs ul.thumbs li').opacityrollover({") & vbNewLine
