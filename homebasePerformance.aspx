<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/EvoStyles/EmptyHomebaseTheme.Master"
  CodeBehind="homebasePerformance.aspx.vb" Inherits="crmWebClient.homebasePerformance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <asp:UpdateProgress ID="splashScreen" runat="server" AssociatedUpdatePanelID="">
    ...
    <asp:UpdatePanel ID="performance_panel" runat="server" ChildrenAsTriggers="True" UpdateMode="Conditional">
      <ContentTemplate>
          <asp:Panel ID="container_performance_listing" runat="server" HorizontalAlign="Center">
