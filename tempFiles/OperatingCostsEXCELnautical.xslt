...
'
'$$Archive: /commonWebProject/tempFiles/OperatingCostsEXCELnautical.xslt $
'$$Author: Mike $
'$$Date: 6/19/19 8:54a $
'$$Modtime: 6/18/19 6:12p $
'$$Revision: 2 $
'$$Workfile: OperatingCostsEXCELnautical.xslt $
'
' ********************************************************************************
-->
     ...
     xmlns:html="http://www.w3.org/TR/REC-html40">
      ...
      <Worksheet ss:Name="CostOfOps">
        ...
        <Table ss:ExpandedRowCount="57" x:FullColumns="1" x:FullRows="1" ss:StyleID="s66">
          ...
          <Row ss:StyleID="Default">
            <Cell ss:StyleID="s70">
              <Data ss:Type="String">Block Speed Nautical Miles Per Hour</Data>
            </Cell>
            <xsl:for-each select="NewDataSet/opCosts">
              <Cell ss:StyleID="s68">
                <Data ss:Type="Number">
          ...
          <Row ss:StyleID="Default">
            <Cell ss:StyleID="s73">
              <Data ss:Type="String">Total Cost Per Nautical Mile</Data>
            </Cell>
            <xsl:for-each select="NewDataSet/opCosts">
          ...
          <Row ss:StyleID="Default">
            <Cell ss:StyleID="s70">
              <Data ss:Type="String">Nautical Miles</Data>
            </Cell>
            <xsl:for-each select="NewDataSet/opCosts">
              <Cell ss:StyleID="s64">
                <Data ss:Type="Number">
          ...
          <Row ss:StyleID="Default">
            <Cell ss:StyleID="s70">
              <Data ss:Type="String">&#160;&#160;Cost/Nautical Mile</Data>
            </Cell>
            <xsl:for-each select="NewDataSet/opCosts">
