...
'
'$$Archive: /commonWebProject/tempFiles/OperatingCostsEXCELmetric.xslt $
'$$Author: Mike $
'$$Date: 6/19/19 8:54a $
'$$Modtime: 6/18/19 6:12p $
'$$Revision: 2 $
'$$Workfile: OperatingCostsEXCELmetric.xslt $
'
' ********************************************************************************
-->
     ...
     xmlns:html="http://www.w3.org/TR/REC-html40">
      ...
      <Worksheet ss:Name="CostOfOps">
        ...
        <Table ss:ExpandedRowCount="57" x:FullColumns="1" x:FullRows="1" ss:StyleID="s66">
          ...
          <Row ss:StyleID="Default">
            <Cell ss:StyleID="s75">
              <Data ss:Type="String">DIRECT COSTS PER HOUR (Metric)</Data>
            </Cell>
            <xsl:for-each select="NewDataSet/opCosts">
              <Cell ss:StyleID="s75">
                <Data ss:Type="String">
          ...
          <Row ss:StyleID="Default">
            <Cell ss:StyleID="s70">
              <Data ss:Type="String">&#160;&#160;Fuel Cost Per Liter</Data>
            </Cell>
            <xsl:for-each select="NewDataSet/opCosts">
              <Cell ss:StyleID="s79">
                <Data ss:Type="Number">
          ...
          <Row ss:StyleID="Default">
            <Cell ss:StyleID="s70">
              <Data ss:Type="String">&#160;&#160;Additive Cost Per Liter</Data>
            </Cell>
            <xsl:for-each select="NewDataSet/opCosts">
              <Cell ss:StyleID="s79">
                <Data ss:Type="Number">
          ...
          <Row ss:StyleID="Default">
            <Cell ss:StyleID="s70">
              <Data ss:Type="String">&#160;&#160;Burn Rate (Liters Per Hour)</Data>
            </Cell>
            <xsl:for-each select="NewDataSet/opCosts">
              <Cell ss:StyleID="s79">
                <Data ss:Type="Number">
          ...
          <Row ss:StyleID="Default">
            <Cell ss:StyleID="s70">
              <Data ss:Type="String">Block Speed Kilometers Per Hour</Data>
            </Cell>
            <xsl:for-each select="NewDataSet/opCosts">
              <Cell ss:StyleID="s68">
                <Data ss:Type="Number">
          ...
          <Row ss:StyleID="Default">
            <Cell ss:StyleID="s73">
              <Data ss:Type="String">Total Cost Per Kilometer</Data>
            </Cell>
            <xsl:for-each select="NewDataSet/opCosts">
          ...
          <Row ss:StyleID="Default">
            <Cell ss:StyleID="s75">
              <Data ss:Type="String">ANNUAL FIXED COSTS (Metric)</Data>
            </Cell>
            <xsl:for-each select="NewDataSet/opCosts">
              <Cell ss:StyleID="s75">
                <Data ss:Type="String">
          ...
          <Row ss:StyleID="Default">
            <Cell ss:StyleID="s76">
              <Data ss:Type="String">ANNUAL BUDGET (Metric)</Data>
            </Cell>
            <xsl:for-each select="NewDataSet/opCosts">
              <Cell ss:StyleID="s75">
                <Data ss:Type="String">
          ...
          <Row ss:StyleID="Default">
            <Cell ss:StyleID="s70">
              <Data ss:Type="String">Kilometers</Data>
            </Cell>
            <xsl:for-each select="NewDataSet/opCosts">
              <Cell ss:StyleID="s64">
                <Data ss:Type="Number">
          ...
          <Row ss:StyleID="Default">
            <Cell ss:StyleID="s70">
              <Data ss:Type="String">&#160;&#160;Cost/Kilometer</Data>
            </Cell>
            <xsl:for-each select="NewDataSet/opCosts">
          ...
          <Row ss:StyleID="Default">
            <Cell ss:StyleID="s70">
              <Data ss:Type="String">&#160;&#160;Cost/Seat Kilometer</Data>
            </Cell>
            <xsl:for-each select="NewDataSet/opCosts">
          ...
          <Row ss:StyleID="Default">
            <Cell ss:StyleID="s70">
              <Data ss:Type="String">&#160;&#160;Cost/Statute Kilometer</Data>
            </Cell>
            <xsl:for-each select="NewDataSet/opCosts">
