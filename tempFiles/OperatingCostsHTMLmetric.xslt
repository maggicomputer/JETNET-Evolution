...
'
'$$Archive: /commonWebProject/tempFiles/OperatingCostsHTMLmetric.xslt $
'$$Author: Mike $
'$$Date: 6/19/19 8:55a $
'$$Modtime: 6/18/19 6:12p $
'$$Revision: 2 $
'$$Workfile: OperatingCostsHTMLmetric.xslt $
'
' ********************************************************************************
-->
  ...
  <xsl:template match="/">
    ...
    <html xmlns:o="urn:schemas-microsoft-com:office:office"
      ...
      <head>
        ...
        <title>JETNET - Export of Current Operating Costs List (Metric)</title>
      </head>
      ...
      <body link="blue" vlink="purple" style="margin-top: 10px; margin-left: 10px;">
        <table border="0" cellpadding="0" cellspacing="0" width="367" style='border-collapse:collapse;table-layout:fixed;width:275pt'>
          ...
          <tr height='17' valign='bottom' style='height:12.75pt'>
            ...
            <xsl:for-each select="NewDataSet/opCosts">
              <td width='151' style='width:171pt'>&#160;</td>
            </xsl:for-each>
          </tr>
          <tr height='17' valign='bottom' style='height:12.75pt'>
            ...
            style='height:12.75pt'>
              <font face="Arial">
                <b>DIRECT COSTS PER HOUR (Metric)</b>
              </font>
            </td>
          ...
          <tr height="17" valign="bottom" style='height:12.75pt'>
            <td height='17' class='xl72' style='height:12.75pt'>
              <font face="Arial">Kilometers</font>
            </td>
            <xsl:for-each select="NewDataSet/opCosts">
