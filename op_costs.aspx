<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="op_costs.aspx.vb" Inherits="crmWebClient.op_costs"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:panel CssClass="search_pnl" ID="main_pnl" runat="server" BackColor="#D4FAE9" Width="98%">
    ...
    <asp:Label name='Build_OperatingCosts_Label' ID='Build_OperatingCosts_Label' runat="server" Width="300"></asp:Label>
</asp:Content>
